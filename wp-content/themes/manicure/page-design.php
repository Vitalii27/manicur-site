            ...
            <ul class="course_list">
                ...
                <li class="program_item desing-nogtey">
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>Красивые ногти – в ваших руках, ведь мы научим вас создавать на них самые необычные
                                рисунки, узоры и дизайны. Nail art – это искусство по украшению ногтей, и мы готовы
                                обучить ему вас! За программу вы узнаете, как правильно наносить покрытие и как украшать
                                ногти разными способами.</p>
                        </div>
                    </div>
                    <div class="program_btn--vip ">
                        <a href="https://www.shkola-nika.ru/obuchenie-nail-art" class="program_link">Подробнее</a>
                    </div>
                ...
                <li class="program_item desing-nogtey">
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>Этот курс позволит вам научиться делать китайскую роспись, украшать ногти литьем фольгой
                                или жидкими камнями. Все инструменты и материалы предоставим! Мы научим вас правильно
                                пользоваться различными типами кисточек – плоскими или скошенными, кистью-щеткой или
                    ...
                    <div class="program_btn--vip ">
                        <a href="https://www.shkola-nika.ru/kitajskaya-rospis-lite-folgoj-zhidkie-kamni"
                           class="program_link">Подробнее</a>
                    </div>
                ...
                <li class="program_item desing-nogtey">
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>После обучения на этом курсе вы станете настоящим мастером мехенди! Это искусство росписи
                                на руках или теле с помощью хны. Мы расскажем о происхождении этой техники, научим
                                правильно держать руку и конус с хной, познакомим с основными схемами узоров и
                                составлением композиций. Нанесение мехенди обязательно отрабатываются на практике!</p>
                        </div>
                    </div>
                    <div class="program_btn--vip ">
                        <a href="https://www.shkola-nika.ru/kursy-mekhendi" class="program_link">Подробнее</a>
                    </div>
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>Во время этого курса вы научитесь создавать на ногтях самые настоящие произведения
                                искусства посредством трафаретов и красок. Аэрография выполняется гель-лаком с помощью
                                специального распылителя. Он аккуратно наносит краску, благодаря чему получаются четкие
                ...
                <li class="program_item desing-nogtey"
                    style="height: 806px; position: absolute; left: 781.968px; top: 3384px;">
                    <div class="program_img"
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>Этот курс направлен на обучение художественной лепке гелем для создания объемных рисунков
                                3D, 4D на ногтях. Мы расскажем о техниках моделирования и разнообразии дизайнов, научим
                                правильно выбирать материалы. Вы сможете создавать самые разные узоры на поверхности
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>Курс «Мультидизайн» познакомит вас с такими понятиями, как набросок, тени, блики,
                                ...
                                карандашей. Вы научитесь готовить типсы к работе, проработаете основные этапы нанесения
                ...
                <li class="program_item desing-nogtey">
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>Умение создавать декоративную роспись – одно из основных достоинств мастера ногтевого
                                сервиса. Мы готовы научить вас основам декоративной росписи, расскажем о материалах для
                                выполнения дизайна, подборе кистей, гель-лаков и гель-красок. Вы потренируетесь на
                                практике создавать самые разные дизайны – вензеля, втирку, бархатный песок, матовое
                                покрытие, трафаретную розу.</p>
                        </div>
                    </div>
                    <div class="program_btn--vip ">
                        <a href="https://www.shkola-nika.ru/kursy-osnovy-dekorativnoj-rospisi" class="program_link">Подробнее</a>
                    </div>
                ...
                <li class="program_item desing-nogtey">
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>Во время этого курса мы научим вас выполнять инкрустацию на ногтях стразами и бульонками.
                                В теории вы узнаете о видах этих декоративных элементов, особенностях их крепления. На
                                практике мы научимся прорисовывать различные дизайны (вишенка, подсолнух, гранат,
                                снегирь, новогодний венок) и украшать с помощью страз.</p>
                        </div>
                    </div>
                    <div class="program_btn--vip ">
                        <a href="https://www.shkola-nika.ru/kursy-po-manikyuru-crystal-nails" class="program_link">Подробнее</a>
                    </div>
                ...
                <li class="program_item desing-nogtey">
                    ...
                    <div class="program_text">
                        ...
                        <div class="program_text-desc">
                            <p>Этот курс познакомит вас с использованием акварельных гель-лаков в дизайне ногтей.
                                Акварельная техника позволяет создать нежный, воздушный маникюр с легким эффектом
                                градиента. Наши мастера расскажут о спектре цветов лаков, материалах для выполнения
                                дизайна. А на практике вы научитесь таким дизайнам, как камень, дым, космос, перо,
                                бабочка.</p>
                        </div>
                    </div>
                    <div class="program_btn--vip ">
