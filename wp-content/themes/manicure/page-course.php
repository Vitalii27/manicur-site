...
<?php get_template_part('./template-parts/sections/new-section-resnicy'); ?>

<?php get_template_part('./template-parts/sections/photo3'); ?>
<?php get_template_part('./template-parts/sections/schedule'); ?>
<?php get_template_part('./template-parts/sections/new-form-resnicy'); ?>
<?php if (get_field('new-form-resny') == 'false'): ?>
    ...
    <div class="container-fluid">
        <ul class="vip-advantages">
            <li class="vip-advantages_item">
                ...
                <h4 class="vip-advantages_title">Сертификат</h4>
                <div class="vip-advantages_desc">
                    <p>Наличие Сертификата нашего Учебного Центра – залог того, что вы будете нарасхват в Лучших Салонах
                        России.
