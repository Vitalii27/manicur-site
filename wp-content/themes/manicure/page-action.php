...
<section class="section container-fluid title-page">
    <h3 class="vip-title">Акции школы</h3>
</section>
<?php get_template_part('./template-parts/sections/action-list'); ?>
...
<script>
    var mapConfig = {
        maps: [{
            ...
            zoom: 15,
            icon: '<?php echo get_template_directory_uri() ?>/assets/images/marker-1.png',
