...
<div class=" about-school--vip about-school--home" id="about">
    ...
    <div class="container-fluid">
        ...
        <ul class="schedule_list">
            <li class="schedule_item">
                ...
                <div class="schedule_item-bottom">
                    <div class="schedule_item-icon">
                        <img src="https://www.shkola-nika.ru/wp-content/uploads/2019/03/sun2.png" alt="icon" class="schedule_item-img">
                    </div>
            ...
            <li class="schedule_item">
                ...
                <div class="schedule_item-bottom">
                    <div class="schedule_item-icon">
                        <img src="https://www.shkola-nika.ru/wp-content/uploads/2019/03/moon2.png" alt="icon" class="schedule_item-img">
                    </div>
                    <div class="schedule_table">
            ...
            <li class="schedule_item">
                ...
                <div class="schedule_item-bottom">
                    <div class="schedule_item-icon">
                        <img src="https://www.shkola-nika.ru/wp-content/uploads/2019/03/balloons2.png" alt="icon" class="schedule_item-img">
                    </div>
                    <div class="schedule_table">
